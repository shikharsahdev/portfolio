  ...
  const keyExperiences = [
    {
      ...
      text: 'Indian Council of Medical Research & All India Institute of Medical Sciences; I had the opportunity to work with these esteemed institutions, contributing to projects aimed at improving healthcare through technology. It was a humbling experience to play a part in such impactful work wherein, I helped build solutions to introduce digitizaton of patient enrolment in Trauma centres in India, under the guidance of Dr. Amit Gupta.',
        ...
        <div className="flex flex-col gap-24">
        {
          keyExperiences.reverse().map(experience => (
            <div className='flex flex-col gap-4'>
              ...
              <p className='text-2xl  text-[--primary] font-light'>{experience.text}</p>
            </div>
          ))
        }
        </div>
